...
Cloudflare: [ilovexjp.pages.dev/tfjkt](https://ilovexjp.pages.dev/tfjkt)

Netlify: [ilovexjp.netlify.app/tfjkt](https://ilovexjp.netlify.app/tfjkt)

使用 Demo 时请注意：我们不会主动收集任何访问数据，但不保证网站托管的服务商不会收集访问信息。若担心隐私，可以从 [GitHub Releases](https://github.com/ilovexjp/tfjkt-simulator/releases) 中下载源码自行部署。
